          ...
          return (
            <>
              <Head>
                ...
                <meta property="twitter:title" content={`${repository.full_name} | PairHub`} />
                <meta
                  property="twitter:description"
                  content={`Find remote pair programming partners for ${repository.full_name}`}
                />
                <meta property="twitter:image" content={repository.avatar_url} />
              </Head>
